...
**Prebuilt binaries:** download from the [latest release](https://github.com/astrostl/surplies/releases/tag/v0.13.1) — macOS tarballs, and Linux and Windows binaries for amd64 and arm64.
