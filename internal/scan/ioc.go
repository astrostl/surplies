...
var KnownRepoPayloadHashes = []RepoPayloadHash{
	...
	{
		// Incident-specific addition explicitly requested by the developer.
		// Source: ../battlestation/DUNE.md, "The sample" / "Indicators".
		// Independently verified against the local quarantined bytes on 2026-09-19.
		...
		// "DUNE" is a private incident codename and means nothing to anyone
		// reading a finding, so it stays in the comments and out of Desc.
	...
	},
	{
		...
		//
		// Incident-specific addition explicitly requested by the developer.
		// Source: ../battlestation/DUNE.md, "The August sample".
		// Recovered from responder transcripts, not from a repo: every remote
		// was cleaned before a copy was kept. Pure ASCII, so it round-tripped
		// through the transcript JSON losslessly and the hash describes real
		// bytes. No independent public report of these hashes was found.
